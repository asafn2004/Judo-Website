  ...
  return (
   ...
   <div className="cta1">
      ...
      <div className="text1">
         ...
         <p className="content1">יו"ר המרכזים לג'ודו והגנה עצמית, שופט בכיר באיגוד הג'ודו הישראלי ובעל תעודות הסמכה רבות כולל מאמן ג'ודו בכיר ממכון ויגנייט, מאמן לוחמים למערך אבטחה ועוד...

יואל גידל דורות של ספורטאים, מאמנים מדריכים ושופטים. מומחה באימון אוכלוסיות בעלות צרכים מיוחדים, ספיישל אולימפיקס, נכים ונוער בסיכון.
